...
| `110/` | Lecture 11 — Simpson's Rule, Lagrange, Newton-Cotes | [Slides](https://waseda-num-analysis-2026.github.io/materials/110/11th.html) · [Assignment](110/assignment/) (copy `README.md`, `ex11-1.qmd`, `ex11-2.qmd` to Ex 10–12 repo root; overwrite `README.md`) | [Watch](https://youtu.be/m6ysxhTU50Y) |
| `120/` | Lecture 12 — Hermite, Gauss Quadrature | [Slides](https://waseda-num-analysis-2026.github.io/materials/120/12th.html) · [Assignment](120/assignment/) (copy `README.md`, `ex12-1.qmd`, `ex12-2.qmd` to Ex 10–12 repo root; overwrite `README.md`) | [Watch](https://youtu.be/925feSlSQQs) |
...
| 5.0 | Evolve the Handout with AI (≥ 3 Q&A in `linear-equations-handout.qmd`, focused on Sections 1--4, see [`AI_TUTOR.md`](AI_TUTOR.md)) | same repo as 5.1 | **May 21, 23:59** |
...
| 6.0 | Evolve the Shared Handout with AI (≥ 3 Q&A in `linear-equations-handout.qmd`, focused on Sections 5 onward (formerly Sections 9 onward), see [`AI_TUTOR.md`](AI_TUTOR.md)) | same repo as 6.1 | **May 28, 23:59** |
