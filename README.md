...
| `070/` | Nonlinear Equations I: Fixed-Point Iteration and Newton's Method | [Slides](https://waseda-num-analysis-2026.github.io/materials/070/7th.html) · Handout `nonlinear-equations-handout.html` *(shared with Lecture 8; not yet published)* | — |
