...
<div style="padding-left: 2em; margin-top: 0.4em; margin-bottom: 0.6em; font-size: 0.9em;">
  <strong>Edit:</strong> <code>ex2-3.qmd</code> (same repo as Ex 2.1)
  &nbsp;&nbsp;|&nbsp;&nbsp; <strong style="color: #d84315;">Deadline: Apr 30 (Wed), 23:59</strong>
</div>

<div style="display:grid; grid-template-columns:1.15fr 1fr; gap:1.2em; padding:0 1em;">

<div>

Implement `solve_quadeq(a, b, c)` returning the two solutions of
...
1. **Why** the standard formula suffers from cancellation here
2. **How** your implementation avoids it
3. **Compare** accuracy with the direct formula

<div style="margin-top:0.7em; padding:0.5em 0.7em; background:#f3e5f5; border-left:3px solid #6a1b9a; border-radius:6px; font-size:0.82em;">
📝 <strong>Plus:</strong> a 5-min video — upload to <strong>YouTube unlisted</strong> (recommended) or any link-shareable service (Drive / Dropbox / OneDrive / …) and paste the URL into <code>ex2-3.qmd</code>.<br>
