...
1. Open this file in VS Code with GitHub Copilot installed.
2. Find a line you don't understand.
...
4. Re-render: `quarto render 2nd-handout.qmd` — your question and its
   answer are now part of the handout (collapsed by default; click to expand).

See [`AI_TUTOR.md`](../../../AI_TUTOR.md) at the repo root for the full
rule set the AI follows, and for more prompt templates (follow-ups,
concept questions, Q&A index).
...
You can of course also edit this file by hand, run/modify the code cells,
and add freeform notes anywhere — the AI Q&A workflow is **one option,
not a requirement**.
:::
...
```{python}
# Try it in Python
print(f"10.0**40 + 500.0 - 10.0**40 = {10.0**40 + 500 - 10.0**40}")
print(f"8.3 - 8 = {8.3 - 8}")
